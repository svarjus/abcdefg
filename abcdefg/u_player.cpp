...
void* g::UnityEngine_Networking_UnityWebRequest__Get(System_String_o* uri)
{
	...
	std::string url = ResolveSystemString(uri);

	//std::cout << url << "]\n";

	AddLog(std::format("opening url: {}\n", url));
	...
	return UnityEngine_Networking_UnityWebRequest__Get_f(uri);

}
void* g::UnityEngine_Networking_UnityWebRequest__Post(System_String_o* uri, System_String_o* postData)
{

	std::string url = ResolveSystemString(uri);
	std::string postdata = ResolveSystemString(postData);

	//std::cout << "Post URL: [" << url << "]\n";
	//std::cout << "Post DATA: [" << postdata << "]\n";

	AddLog(std::format("POST URL: {}\n", url));
	AddLog(std::format("POST DATA: {}\n", postdata));

	return UnityEngine_Networking_UnityWebRequest__Post_f(uri, postData);
}
